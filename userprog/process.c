...
load (const char *file_name, void (**eip)(void), void **esp)
{
        ...
        // if (argv[0])
        //         printf("All is good out\n");
        // else printf ("NULL outs\n");
        filesys_acquire_external_lock();
...
{
        char *save_ptr = file_name, *token;
        // printf ("First time here, name is %s\n", file_name);
